...
class _FavouritesPageState extends State<FavouritesPage> {
  ...
  Future<void> _removeFavourite(String url) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Removed from favourites', style: TextStyle(color: Colors.white),),
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(
            ...
            size: 18,
            color: Color.fromARGB(221, 239, 236, 236),
          ),
            ...
            children: [
              ...
              TextSpan(
                ...
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 172, 170, 172),
                ),
              ),
            ],
          ),
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    ...
                    size: 64,
                    color: const Color.fromARGB(255, 233, 64, 64),
                  ),
                        ...
                        Image.network(
                          ...
                          loadingBuilder: (_, child, progress) {
                            ...
                            return Container(
                              ...
                              child: const Center(
                                child: CircularProgressIndicator(
                                  color: Color.fromARGB(255, 181, 139, 188),
                                  strokeWidth: 2,
                                ),
                              ),
                            );
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 3, 3, 3).withValues(alpha: 0.8),
