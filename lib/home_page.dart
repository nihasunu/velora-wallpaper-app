...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadMoreWallpapers() async {
    ...
    try {
      _currentPage++;
      final urls = await PexelsService.fetchWallpapers(
        query: currentQuery,
        page: _currentPage,
      );
      setState(() {
        wallpaperUrls.addAll(urls);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 19, 17, 19),
      body: SafeArea(
        child: Column(
    ...
    return Expanded(
      child: Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: wallpaperUrls.length + (_isLoadingMore ? 1 : 0),
          itemBuilder: (context, index) {
